...
namespace CSProject
{
    ...
    class Admin : Staff
    {
        ...
        public override string ToString()
        {
            return "\nNameOfAdministrator: " + NameOfStaff + "\nadminHourlyRate: " + adminHourlyRate + "\nHoursWorked: " + HoursWorked + "\nBasicPay: " + BasicPay
                 + "\nOvertime: " + Overtime + "\nTotalPay: " + TotalPay;
        }
    }
    class FileReader
        ...
        static void Main(string[] args)
        {
            ...
            while (month == 0)
            {
                ...
                try
                {
                    ...
                    if(month < 1 || month > 12)
                    {
                        Console.WriteLine("Invalid input: number must be between 1 and 12 inclusive");
                        month = 0;
                    }
                }
                catch(Exception e)
